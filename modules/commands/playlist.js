...
module.exports = {
  ...
  execute: async function(message, args) {
    ...
    if (!channel)
      return sendError(
        "I'm sorry but you need to be in a voice channel to play music! <:yon:789399503346204732>",
        message.channel
      );
    ...
    if (!permissions.has("CONNECT"))
      return sendError(
        "I cannot connect to your voice channel, make sure I have the proper permissions! <:yon:789399503346204732>",
        message.channel
      );
    if (!permissions.has("SPEAK"))
      return sendError(
        "I cannot speak in this voice channel, make sure I have the proper permissions! <:yon:789399503346204732>",
        message.channel
      );
    ...
    if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
      try {
        ...
        console.error(error);
        return sendError("Playlist not found :(", message.channel).catch(
          console.error
        );
      }
    } else {
      try {
        ...
        if (searched.playlists.length === 0)
          return sendError(
            "This is literally a list of... nothing!)",
            message.channel
          );
